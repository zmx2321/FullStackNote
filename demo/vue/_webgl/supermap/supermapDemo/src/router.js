...
import SupermapDemo4 from './views/supermapDemo/SupermapDemo4'
import SupermapDemo5 from './views/supermapDemo/SupermapDemo5'
    ...
    routes: [
        ...
        // 如果访问index则跳转到index路径
        {
            ...
            children: [
                ...
                { path: '/supermap_demo4', component: SupermapDemo4, name: 'supermap_demo4' },
                { path: '/supermap_demo5', component: SupermapDemo5, name: 'supermap_demo5' },
            ]
        },
        // 登陆页面
        {
