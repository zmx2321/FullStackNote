 ...
 */
{
  ...
  VisibilityTester.prototype.addPin = function(pin) {
    ...
    this._markers[pinId] = new xeogl.Mesh(this._scene, {
      geometry:
        this._scene.components['_pinMarkerGeometry'] ||
        new xeogl.Geometry(this._scene, {
      ...
      material:
        this._scene.components['_pinMarkerMaterial'] ||
        new xeogl.PhongMaterial(this._scene, {
  ...
  xeogl.Pin = class xeoglPin extends xeogl.Component {
    ...
    /**
         ...
         */
    set bary(value) {
      this._bary = value || xeogl.math.vec3([0.3, 0.3, 0.3]);
      this._setLocalPosDirty();
    ...
    get canvasPos() {
      ...
      xeogl.math.transformPoint4(
        this.scene.camera.projMatrix,
        tempVec4a,
        tempVec4b,
      );
      ...
      this._canvasPos[0] = Math.floor(
        ((1 + tempVec4b[0] / tempVec4b[3]) * aabb[2]) / 2,
      );
      this._canvasPos[1] = Math.floor(
        ((1 - tempVec4b[1] / tempVec4b[3]) * aabb[3]) / 2,
      );
    ...
    _meshAttached(mesh) {
      this._onGeometryBoundary = mesh.geometry.on(
        'boundary',
        this._setLocalPosDirty,
        this,
      );
